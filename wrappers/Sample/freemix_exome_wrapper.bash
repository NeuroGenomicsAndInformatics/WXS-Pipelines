#!/bin/bash
# This wrapper script generates the selfSM and Ancestry files for an WES sample
...
${REF_DIR}:/ref" \
LSF_DOCKER_ENV_FILE=$SCRIPT_DIR/../../baseEnvs/references_2_1.env \
bsub -g ${JOB_GROUP_QC} \
    -J ngi-${USER}-freemix \
    -Ne \
    -n 2 \
    ...
    bash /scripts/vbid_exome.bash $FULL_CRAM
