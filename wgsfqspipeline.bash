...
bsub -g ${JOB_GROUP_GPU} \
  ...
  -R '{ select[gpuhost && mem>170GB] rusage[mem=170GB/job, ngpus_physical=1] affinity[thread(16)] span[hosts=1] } || { select[mem>4GB] rusage[mem=4GB/job] affinity[thread(1)] }@5' \
