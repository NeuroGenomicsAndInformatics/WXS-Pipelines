...
echo -e "TMP_DIR=/scratch1/fs1/${SCRATCH_USER}/${USER}/parabricks-tmp/${FULLSMID}" >> $ENV_FILE
[ ! -d /scratch1/fs1/${SCRATCH_USER}/${USER}/parabricks-tmp/${FULLSMID} ] && mkdir /scratch1/fs1/${SCRATCH_USER}/${USER}/parabricks-tmp/${FULLSMID}
...
[ ! -d /scratch1/fs1/${SCRATCH_USER}/${USER}/c1out/logs/${FULLSMID} ] && mkdir /scratch1/fs1/${SCRATCH_USER}/${USER}/c1out/logs/${FULLSMID}
rsync $ENV_FILE /storage1/fs1/${STORAGE_USER}/Active/$USER/c1out/${FULLSMID}/
