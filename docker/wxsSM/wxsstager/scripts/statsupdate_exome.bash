...
## Get Coverage Stats
PADEX_COV=$(head -n2 ${OUTDIR}/${FULLSMID}*.cram.docmetrics_paddedexome.sample_summary | tail -n1 | cut -d, -f3)
...
## Get sex information
bash /scripts/sex_check_coverage.bash ${OUTDIR}/${FULLSMID}*.cram