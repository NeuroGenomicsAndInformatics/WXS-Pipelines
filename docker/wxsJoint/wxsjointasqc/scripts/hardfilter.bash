...
&& rm ${NAMEBASE}-PASS-maxDP${SNV_DP_TR}.vcf.gz && rm ${NAMEBASE}-PASS-maxDP${SNV_DP_TR}.vcf.gz.tbi
...
&& rm ${NAMEBASE}-PASS-maxDP${SNV_DP_TR}-LCR.vcf.gz && rm ${NAMEBASE}-PASS-maxDP${SNV_DP_TR}-LCR.vcf.gz.tbi
...
&& rm ${NAMEBASE}-PASS-maxDP${SNV_DP_TR}-LCR-nonVariants.vcf.gz && rm ${NAMEBASE}-PASS-maxDP${SNV_DP_TR}-LCR-nonVariants.vcf.gz.tbi
