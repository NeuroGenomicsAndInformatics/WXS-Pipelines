...
&& rm ${NAMEBASE}-PASS.vcf.gz && rm ${NAMEBASE}-PASS.vcf.gz.tbi
...
&& rm ${NAMEBASE}-PASS-LCR.vcf.gz && rm ${NAMEBASE}-PASS-LCR.vcf.gz.tbi
...
&& rm ${NAMEBASE}-PASS-LCR-nonVariants.vcf.gz && rm ${NAMEBASE}-PASS-LCR-nonVariants.vcf.gz.tbi
...
&& rm ${NAMEBASE}-PASS-LCR-nonVariants-AF1.vcf.gz && rm ${NAMEBASE}-PASS-LCR-nonVariants-AF1.vcf.gz.tbi
...
&& rm ${NAMEBASE}-PASS-LCR-nonVariants-AF1-ABannotated.vcf.gz && rm ${NAMEBASE}-PASS-LCR-nonVariants-AF1-ABannotated.vcf.gz.tbi
...
bcftools norm \
	...
	-m -any \
	-o ${NAMEBASE}-PASS-LCR-nonVariants-AF1-ABfiltered.splitMA.vcf.gz \
	${NAMEBASE}-PASS-LCR-nonVariants-AF1-ABfiltered.vcf.gz \
	&& tabix -s1 -b2 -e2 ${NAMEBASE}-PASS-LCR-nonVariants-AF1-ABfiltered.splitMA.vcf.gz

SUCCESS=$?

[[ $SUCCESS -eq 0 ]] && rm ${NAMEBASE}-PASS-LCR-nonVariants-AF1-ABfiltered.vcf.gz && rm ${NAMEBASE}-PASS-LCR-nonVariants-AF1-ABfiltered.vcf.gz.tbi

echo "splitMA,${NAMEBASE}-PASS-LCR-nonVariants-AF1-ABfiltered.splitMA.vcf.gz,$(zcat ${NAMEBASE}-PASS-LCR-nonVariants-AF1-ABfiltered.splitMA.vcf.gz | grep -v '^#' | wc -l)" >> $COUNT_FILE
